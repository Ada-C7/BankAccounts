...
describe "Wave 2" do
  ...
  describe "Account.find" do
    it "Returns an account that exists" do
      ...
      account.created.must_equal "2003-11-07 11:34:56 -0800"
    ...
    it "Can find the first account from the CSV" do
      ...
      account.created.must_equal "1999-03-27 11:30:09 -0800"
    ...
    it "Can find the last account from the CSV" do
      ...
      account.created.must_equal "1994-11-17 14:04:56 -0800"
    end
