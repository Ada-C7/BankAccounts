# Create a SavingsAccount class which should inherit behavior from the
# Account class. It should include the following updated functionality:
...
# rate is 0.25 and the balance is $10,000, then the interest that is returned is $25
# and the new balance becomes $10,025.
